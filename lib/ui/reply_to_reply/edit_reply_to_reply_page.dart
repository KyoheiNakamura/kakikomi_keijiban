...
import 'package:kakikomi_keijiban/ui/reply_to_reply/edit_reply_to_reply_model.dart';
import 'package:keyboard_actions/keyboard_actions.dart';
import 'package:provider/provider.dart';

class EditReplyToReplyPage extends StatelessWidget
    with
        ShowConfirmDialogMixin,
        KeyboardActionsConfigDoneMixin,
        ShowExceptionDialogMixin {
  EditReplyToReplyPage(
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ChangeNotifierProvider<EditReplyToReplyModel>(
        create: (context) => EditReplyToReplyModel(),
        child: Scaffold(
          appBar: AppBar(
            
            title: Text('編集'),
          ),
          body: Consumer<EditReplyToReplyModel>(
