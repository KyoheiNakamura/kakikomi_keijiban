...
import 'package:kakikomi_keijiban/ui/components/reply_to_reply_card/reply_to_reply_card.dart';
...
import 'package:kakikomi_keijiban/ui/reply_to_reply/add_reply_to_reply_page.dart';
import 'package:kakikomi_keijiban/ui/drafts/index_drafts_model.dart';
import 'package:kakikomi_keijiban/ui/reply/edit_reply_page.dart';
    ...
    return Consumer<ReplyCardModel>(builder: (context, model, child) {
      return Stack(
        ...
        children: [
          ...
          /// EditIconButton
          reply.isMe() == true && passedModel is! IndexDraftsModel
