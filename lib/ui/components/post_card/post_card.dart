...
import 'package:kakikomi_keijiban/ui/components/reply_card/reply_card.dart';
...
import 'package:kakikomi_keijiban/ui/reply/add_reply_page.dart';
...
import 'package:kakikomi_keijiban/ui/posts/index_search_result_posts_page.dart';
import 'package:kakikomi_keijiban/ui/post/edit_post_page.dart';
      ...
      return Padding(
        ...
        child: Stack(
          ...
          children: [
                              ...
                              return ActionChip(
                                ...
                                onPressed: () async {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          IndexSearchResultPostsPage(category),
                                    ),
                                  );
                                },
                              );
            ...
            /// EditIconButton
            post.isMe() == true && passedModel is! IndexDraftsModel
              ...
              child: GestureDetector(
                ...
                onTap: () async {
                  await Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          IndexSearchResultPostsPage(post.emotion),
                    ),
                  );
                },
              ),
