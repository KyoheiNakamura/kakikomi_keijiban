...
import 'package:kakikomi_keijiban/ui/authentication/registration_method_model.dart';
import 'package:kakikomi_keijiban/ui/authentication/sign_in_page.dart';
import 'package:kakikomi_keijiban/ui/authentication/sign_up_page.dart';
...
class RegistrationMethodPage extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<RegistrationMethodModel>(
      create: (context) => RegistrationMethodModel(),
      child: Scaffold(
        appBar: AppBar(
          toolbarHeight: 50,
        ...
        body:
            Consumer<RegistrationMethodModel>(builder: (context, model, child) {
