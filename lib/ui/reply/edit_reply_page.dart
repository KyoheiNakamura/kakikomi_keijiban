...
import 'package:kakikomi_keijiban/ui/reply/edit_reply_model.dart';
...
class EditReplyPage extends StatelessWidget
  ...
  EditReplyPage({required this.existingReply, required this.passedModel});
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ChangeNotifierProvider<EditReplyModel>(
        create: (context) => EditReplyModel(),
        child: Scaffold(
          appBar: AppBar(
            
            title: Text('編集'),
          ),
          body: Consumer<EditReplyModel>(
