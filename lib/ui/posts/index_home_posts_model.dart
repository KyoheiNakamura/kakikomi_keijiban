...
import 'package:kakikomi_keijiban/ui/on_boarding/on_boarding_page.dart';
import 'package:shared_preferences/shared_preferences.dart';

class IndexHomePostsModel extends ChangeNotifier
  ...
  Future<void> _openSpecifiedPageByNotification(BuildContext context) async {
    ...
    if (initialMessage?.data['page'] == 'HomePostsPage') {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => IndexHomePostsPage()),
      );
    } else if (initialMessage?.data['page'] == 'MyPostsPage') {
      await Navigator.push(
        context,
        // MaterialPageRoute(builder: (context) => MyPostsPage()),
        MaterialPageRoute(builder: (context) => IndexNoticesPage()),
      );
