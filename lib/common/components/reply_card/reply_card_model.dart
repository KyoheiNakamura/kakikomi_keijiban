...
class ReplyCardModel2 extends ChangeNotifier {
  /// ワカルボタンをonにする
  ...
  Future<void> addEmpathizedPost(Reply reply) async {
    ...
    await replyRef.update(<String, FieldValue>{
  ...
  Future<void> deleteEmpathizedPost(Reply reply) async {
    ...
    final currentEmpathyCount = replySnapshot['empathyCount'] as int;
...
//     if (currentEmpathyCount > 0) {
//       await replyRef.update(<String, int>{
//         'empathyCount': currentEmpathyCount - 1,
//       });
//     }
//   }
